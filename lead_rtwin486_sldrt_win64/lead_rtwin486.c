...
void lead_rtwin486_output(void)
{
  ...
  if (rtmIsMajorTimeStep(lead_rtwin486_M)) {
    ...
    /* Gain: '<Root>/Gain' */
    lead_rtwin486_B.Gain = lead_rtwin486_P.Kc * lead_rtwin486_B.Gain2;
  }
...
RT_MODEL_lead_rtwin486_T *lead_rtwin486(void)
{
  ...
  /* External mode info */
  lead_rtwin486_M->Sizes.checksums[0] = (3335522261U);
  lead_rtwin486_M->Sizes.checksums[1] = (1633294546U);
  lead_rtwin486_M->Sizes.checksums[2] = (3507637374U);
  lead_rtwin486_M->Sizes.checksums[3] = (1265282510U);
  ...
  lead_rtwin486_M->Sizes.numBlocks = (13);/* Number of blocks */

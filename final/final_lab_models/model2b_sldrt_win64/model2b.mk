...
MODEL                := model2b
MODULES              := model2b_data.c model2b_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := model2b.mk
...
#
MODELLIB                  := model2blib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := model2b_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/vjdixit2/ece486;C:/vjdixit2/ece486/model2b_sldrt_win64;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/rtw/c/coecsl/devices

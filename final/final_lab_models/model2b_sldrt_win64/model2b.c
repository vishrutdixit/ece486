...
void model2b_output(void)
{
   ...
   */
  model2b_B.Add3 = model2b_P.Gain2_Gain * model2b_B.Add1 + model2b_P.Gain7_Gain *
    model2b_X.Integrator1_CSTATE;

  /* Gain: '<Root>/Gain5' */
  model2b_B.Gain5 = model2b_P.Gain5_Gain * model2b_B.Add3;
  if (rtmIsMajorTimeStep(model2b_M)) {
...
RT_MODEL_model2b_T *model2b(void)
{
  ...
  /* External mode info */
  model2b_M->Sizes.checksums[0] = (1065066005U);
  model2b_M->Sizes.checksums[1] = (2224308596U);
  model2b_M->Sizes.checksums[2] = (2539433378U);
  model2b_M->Sizes.checksums[3] = (4233231978U);
  ...
  model2b_M->Sizes.numBlocks = (23);   /* Number of blocks */
  model2b_M->Sizes.numBlockIO = (8);   /* Number of block outputs */
  model2b_M->Sizes.numBlockPrms = (21);/* Sum of parameter "widths" */
  return model2b_M;
}

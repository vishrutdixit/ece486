...
MODEL                := model6_threestate_rwp
MODULES              := model6_threestate_rwp_data.c model6_threestate_rwp_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := model6_threestate_rwp.mk
...
#
MODELLIB                  := model6_threestate_rwplib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := model6_threestate_rwp_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;U:/ece486/final/final_lab_models;U:/ece486/final/final_lab_models/model6_threestate_rwp_sldrt_win64;C:/vjdixit2/final_lab_models;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/rtw/c/coecsl/devices

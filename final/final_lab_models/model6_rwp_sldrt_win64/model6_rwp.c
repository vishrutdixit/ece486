...
void model6_rwp_output(void)
{
  ...
  for (iy = 0; iy < 4; iy++) {
    ...
    rtb_Gain = model6_rwp_P.StateSpace_C[12 + iy] *
    ...
    /* Gain: '<Root>/Gain2' */
    rtb_Gain2_0 += -model6_rwp_P.K[iy] * rtb_Gain;
  }

  /* Gain: '<Root>/Gain5' incorporates:
   *  Gain: '<Root>/Gain2'
   */
  model6_rwp_B.Gain5 = model6_rwp_P.Gain5_Gain * rtb_Gain2_0;
  if (rtmIsMajorTimeStep(model6_rwp_M)) {
     ...
     *  Fcn: '<Root>/Fcn'
     */
    if (cos(rtb_Gain) >= model6_rwp_P.Switch_Threshold) {
      tmp = model6_rwp_P.Constant2_Value;
    } else {
      tmp = model6_rwp_P.Constant1_Value;
    }

    /* End of Switch: '<Root>/Switch' */

    /* Sum: '<Root>/Add2' */
    model6_rwp_B.Add2 = rtb_Gain - tmp;
  }
...
RT_MODEL_model6_rwp_T *model6_rwp(void)
{
  ...
  rtmSetTFinal(model6_rwp_M, 3000.0);
  model6_rwp_M->Timing.stepSize0 = 0.005;
  model6_rwp_M->Timing.stepSize1 = 0.005;

  /* External mode info */
  model6_rwp_M->Sizes.checksums[0] = (3624476626U);
  model6_rwp_M->Sizes.checksums[1] = (4209941137U);
  model6_rwp_M->Sizes.checksums[2] = (582140541U);
  model6_rwp_M->Sizes.checksums[3] = (3895710598U);
  ...
  model6_rwp_M->Sizes.numBlocks = (16);/* Number of blocks */
  model6_rwp_M->Sizes.numBlockIO = (5);/* Number of block outputs */
  model6_rwp_M->Sizes.numBlockPrms = (60);/* Sum of parameter "widths" */
  return model6_rwp_M;
}

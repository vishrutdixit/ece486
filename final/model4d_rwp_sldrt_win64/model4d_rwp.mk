...
MODEL                := model4d_rwp
MODULES              := model4d_rwp_data.c model4d_rwp_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := model4d_rwp.mk
...
#
MODELLIB                  := model4d_rwplib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := model4d_rwp_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;U:/ece486/final;U:/ece486/final/model4d_rwp_sldrt_win64;C:/vjdixit2;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/rtw/c/coecsl/devices

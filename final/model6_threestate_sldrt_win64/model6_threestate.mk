...
MODEL                := model6_threestate
MODULES              := model6_threestate_data.c model6_threestate_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := model6_threestate.mk
...
#
MODELLIB                  := model6_threestatelib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := model6_threestate_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;U:/ece486/final;U:/ece486/final/model6_threestate_sldrt_win64;C:/vjdixit2;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/rtw/c/coecsl/devices

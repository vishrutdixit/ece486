...
MODEL                := lead_rtwin486
MODULES              := lead_rtwin486_data.c lead_rtwin486_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := lead_rtwin486.mk
...
SHARED_LIB           := 
TARGET_LANG_EXT      := c
OPTIMIZATION_FLAGS   := -O4 -O4 -O4 -O4 -O4
ADDITIONAL_LDFLAGS   := 
DEFINES_CUSTOM       := 
...
#
MODELLIB                  := lead_rtwin486lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := lead_rtwin486_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;U:/ece486/lab6/data;U:/ece486/lab6/data/lead_rtwin486_sldrt_win64;C:/vjdixit2;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/rtw/c/coecsl/devices
